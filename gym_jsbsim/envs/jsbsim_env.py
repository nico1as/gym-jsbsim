...
try:
    ...
    raise error.DependencyNotInstalled("{}. (HINT: install jsbsim from http://www.jsbsim.org".format(e))
...
class JsbsimEnv(gym.Env):
    ...
    def __init__(self, mission_file):
        ...
        if allow_flightgear_output:
            fg_output_config = os.path.join(os.path.dirname(os.path.abspath(__file__)), self.OUTPUT_FILE)
            self.jsbsim.set_output_directive(fg_output_config)
